/**
 * What the two elements share: finding their player, and letting go of it.
 * A copy of the player's own base, because the player exports no base
 * class: a control of the page's own implements the contract from outside
 * (player guide, chapter 03), and so does this package.
 *
