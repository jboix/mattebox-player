...
At any given time we support the _latest_ version of each package (as
...
[report a vulnerability](https://github.com/jboix/mattebox-player/security/advisories/new)
...
Before reporting, make sure you are on the latest version of the packages and
a supported Node version (20.19 or later).
